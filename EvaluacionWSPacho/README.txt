...
a persistence unit "EvaluacionWSPachoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSPacho\pom.xml":
...
artifact ("EvaluacionWSPacho.war") is already built. You can build
